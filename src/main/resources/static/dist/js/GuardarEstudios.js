...
function GuardarEstudio(id, tip)
{
	...
	var FilaReborn = "<tr class='TIPO_" + tip + "' id='" + txt + "_" + id + "'><td>" + nom + "</td><td>" + pre + "</td><td>" + tip + "</td><td><button style='border:none;' onclick=\"MetodoDeAyuda(\'" + tip + "\'" + ", " + id + ");\"><i class='fas fa-plus'></i></button></td></tr>";
...
{		
	switch(accion) 
	{
	  case "ADD":		  
		  ...
		  var temp = {id: id + '_' + txt, precio: pre, can: can, id_real: id, tipo: tip, nom: nom, info: info,fila: FilaReborn, txtNew: txtNew, H1:H1, H2:H2, H3:H3, H4:H4};
		  lista.push(temp);
